        ...
        if (0 === strpos($pathinfo, '/admin')) {
            if (0 === strpos($pathinfo, '/admin/evento')) {
                ...
                if (rtrim($pathinfo, '/') === '/admin/evento') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_evento_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'admin_evento_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\EventoController::indexAction',  '_route' => 'admin_evento_index',);
                }
                not_admin_evento_index:

                // admin_evento_json_index
                if ($pathinfo === '/admin/evento/json') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_evento_json_index;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\EventoController::jsonEventAction',  '_route' => 'admin_evento_json_index',);
                }
                not_admin_evento_json_index:

                // admin_evento_show
                if (preg_match('#^/admin/evento/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_evento_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_evento_show')), array (  '_controller' => 'AppBundle\\Controller\\EventoController::showAction',));
                }
                not_admin_evento_show:
            ...
            if (0 === strpos($pathinfo, '/admin/sensor')) {
                ...
                if (rtrim($pathinfo, '/') === '/admin/sensor') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_sensor_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'admin_sensor_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\SensorController::indexAction',  '_route' => 'admin_sensor_index',);
                }
                ...
                if ($pathinfo === '/admin/sensor/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_admin_sensor_new;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\SensorController::newAction',  '_route' => 'admin_sensor_new',);
                }
                not_admin_sensor_new:

                // admin_sensor_show
                if (preg_match('#^/admin/sensor/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_sensor_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sensor_show')), array (  '_controller' => 'AppBundle\\Controller\\SensorController::showAction',));
                }
                not_admin_sensor_show:

                // admin_sensor_edit
                if (preg_match('#^/admin/sensor/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_admin_sensor_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sensor_edit')), array (  '_controller' => 'AppBundle\\Controller\\SensorController::editAction',));
                }
                not_admin_sensor_edit:

                // admin_sensor_delete
                if (preg_match('#^/admin/sensor/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_admin_sensor_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sensor_delete')), array (  '_controller' => 'AppBundle\\Controller\\SensorController::deleteAction',));
                }
                not_admin_sensor_delete:
