                                        ...
                                        if (count($notifList) > 0) {
                                            ...
                                            foreach ($notifList as $notif) {
                                                ...
                                                if ($notif->getNotificationlistnotificationlist()->getNotificationtypenotificationtype()->getType() == "SMS") {
                                                    ...
                                                    $unidad = $sensor->getSensortypesensortype()->getMeasurement();

                                                    if($sensor->getSensortypesensortype()->getMeasurement()=="%"){
                                                        $unidad = "%25";
                                                    }

                                                    $r = $this->sendSMS ("El sensor ".$sensor->getDescription()." ha generado la alarma: ".$alarma->getDescription()." al marcar ".$var." ".$unidad
