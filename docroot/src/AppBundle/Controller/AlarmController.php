...
class AlarmController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('data_alarm_show', array('id' => $alarm->getId()));
        }
     ...
     *
     * @Route("/{id}/edit", name="data_alarm_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="data_alarm_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Alarm $alarm)
    {
        ...
        return $this->redirectToRoute('data_alarm_index');
    }
    ...
    private function createDeleteForm(Alarm $alarm)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('data_alarm_delete', array('id' => $alarm->getIdalarm())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
